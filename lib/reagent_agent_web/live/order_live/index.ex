defmodule ReagentAgentWeb.OrderLive.Index do
  ...
  def mount(_params, _session, socket) do
    {:ok, stream(socket, :orders, Orders.list_orders(preload: [:lot, :site]))}
  end
  ...
  @impl true
  def handle_info({ReagentAgentWeb.OrderLive.FormComponent, {:saved, order}}, socket) do
